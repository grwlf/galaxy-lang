...
class AliensApiApi(object):
    ...
    def aliens_response_id_get_with_http_info(self, response_id, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('response_id' not in local_var_params or  # noqa: E501
                                                        local_var_params['response_id'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `response_id` when calling `aliens_response_id_get`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'response_id' in local_var_params:
            path_params['responseId'] = local_var_params['response_id']  # noqa: E501
